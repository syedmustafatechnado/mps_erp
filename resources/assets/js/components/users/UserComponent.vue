          ...
          >
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <select v-model="edit_user.division_id" class="form-control">
              ...
              <div class="form-group">
                ...
                <select v-model="edit_user.department_id" class="form-control">
                  <option
              ...
              <div class="form-group">
                ...
                <select v-model="edit_user.designation_id" class="form-control">
                  <option
              ...
              <div class="form-group">
                ...
                <input type="text" id="name" v-model="edit_user.name" class="form-control" required />
              ...
              <div class="form-group">
                ...
                <input type="text" id="name" v-model="edit_user.email" class="form-control" required />
                <span id="name_errs" class="text-danger form_error"></span>
              </div>
              <p>
                <b-alert
        ...
        <div class="modal-content">
          ...
          >
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label class="control-label col-md-4">Email</label>
                <input type="text" id="name" v-model="user.email" class="form-control" required />
                <span id="name_errs" class="text-danger form_error"></span>
              </div>
              <p>
                <b-alert
...
export default {
  ...
  methods: {
    ...
    editUser(id) {
      let uri = "/api/user/create";
      var form_data = new FormData();
      for (var key in this.edit_user) {
        var postValue = this.edit_user[key];
        if (key == "image") {
          postValue = this.dataURLtoFile(this.user[key], "abc.png");
        }
        form_data.append(key, postValue);
      ...
      this.axios.post(uri,form_data,this.headers).then(response => {
        if (response.data.api_status == 0) {
          ...
          this.$store.commit("userEdit", response.data.data, this.user_index);
        }
      });
    },
    deleteUser(id) {
